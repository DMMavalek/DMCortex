...
# High-confidence name corrections only.
REPLACEMENTS = {
    "PRI001697": "Wall of Thorns",
    "PRI001598": "Liveoak",
}
...
def update_json() -> tuple[int, list[str]]:
    ...
    backup = JSON_PATH.with_suffix(".json.pre_safe_name_cleanup.bak")
...
def update_xlsx() -> tuple[int, list[str]]:
    ...
    backup = XLSX_PATH.with_suffix(".xlsx.pre_safe_name_cleanup.bak")
...
def main() -> int:
    ...
    print("- spells.json.pre_safe_name_cleanup.bak")
    print("- Priest_Spells_Complete.xlsx.pre_safe_name_cleanup.bak")
